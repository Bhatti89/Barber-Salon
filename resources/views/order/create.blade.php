...
<div class="imageindiv">
 ...
 <!-- END -->
    ...
    <form action="{{ route ('order.store') }}" method="post">
        ...
        <input type="date" id="P_date" name="P_date" style="width:180px;"><br><br>
        <label for="P_method">Payment Method &nbsp;</label>
        <select id="P_method" name="P_method" required style="width:180px; height:27px;">
        ...
        <label for="ord">Product Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                ...
                <div id="orderContainer" style="display: none;">
                    @foreach($pro as $ord)
                        <input type="checkbox" name="prod[]" value="{{ $ord->id }}">
                        {{ $ord->product_name }}<br><br>
                    @endforeach
                </div>
                <br><br>
